        ...
        <form class="container myContainer " method="POST"   enctype="multipart/form-data"  action="<?= site_url("Shop/newAddOnSubmit") ?>">
            ...
            <div class="row rowHeight">
                ...
                <div class="col-sm-4">
                    ...
                    <span style='color:red'>*</span>
                    <br>
                    <input type="text" placeholder="Enter code" name="addOn_code" value="<?php echo set_value('product_code');?>">
                  <?php if(isset($addOn_code)) echo "<p style='color:red'>$addOn_code </p></center>";?>
