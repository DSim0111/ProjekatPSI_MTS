    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url('Administrator/listShopsPaging') ?>">Home</a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="<?php echo base_url('Administrator/shopApproval') ?>">Shop requests</a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="<?php echo base_url('Administrator/shopReports') ?>">Reported shops</a>
            </li>
            <li class="nav-item ">
