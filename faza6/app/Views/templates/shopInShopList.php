    ...
    <div class="col-sm-12   addBorders rounded shop_content_wrapper  ">
        ...
        <div class="row  text-left addPadding">
            <div class="col-sm-12 rating">
                ...
                echo "<a method='POST' href='".base_url("/User/addToFav?shopId=$shop->id")."><button type='button' class='btn btn-success visit_shop' value='Dodaj u Omiljene'>Dodaj u omiljene</button> </a>";
                }
                ?>
            </div>
        </div>        
